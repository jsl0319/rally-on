...
**2026-09-11 갱신:** 사용자 승인에 따라 본인 거래 제한 접근·탈퇴 전 취소/환불 미리보기·비활성 운영자 및 담당자 인계의 로컬 구현과 검증을 마쳤다. 현재 정책과 검증 결과는 [03-10](03-10-account-transaction-continuity.md)을 따른다. 아래는 최초 검토 근거이며, 보존 기간·실제 운영 담당 체계는 공개 전 확정이 필요하다.
